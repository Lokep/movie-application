<template>
  <div class="social-dynamic">
    <social-dynamic-grid v-for="(item, index) in dynamicData" :key="index" :dynamicInfo="item"></social-dynamic-grid>
  </div>
</template>

<script>
import socialDynamicGrid from '@/components/social/socialDynamicGrid'
export default {
  components: {
    socialDynamicGrid
  },
      ...
      dynamicData: [
        {
          date: "Sep 18 2016",
          title: "正是虾肥蟹壮时",
          imgSrc: "../../../static/images/dynamic/crab.png",
          avatar: "../../../static/images/dynamic/1.png",
          content:
            "菊黄蟹正肥，品尝秋之味。徐志摩把,“看初花的荻芦”和“到楼外楼吃蟹”,并列为秋天来杭州不能错过的风雅之事；用林妹妹的话讲是“螯封嫩玉双双满，",
          reading: "112",
          collection: "96",
          headImgSrc: "../../../static/images/dynamic/crab.png",
          author: "林白衣",
          dateTime: "24小时前",
          detail:
        ...
        },
        {
          ...
          imgSrc: "../../../static/images/dynamic/bl.png",
          reading: 62,
          detail:
          ...
          collection: 92,
          dateTime: "24小时前",
          headImgSrc: "../../../static/images/dynamic/bl.png",
          author: "迷的城",
          date: "Nov 20 2016",
          avatar: "../../../static/images/dynamic/1.png",
          postId: 1
        },
        {
          ...
          imgSrc: "../../../static/images/dynamic/sls.jpg",
          headImgSrc: "../../../static/images/dynamic/sls.jpg",
          reading: 62,
          collection: 92,
          author: "知乎",
          date: "Nov 12 2016",
          dateTime: "三天前",
          avatar: "../../../static/images/dynamic/3.png",
          postId: 2
        },
        {
          ...
          imgSrc: "../../../static/images/dynamic/xiaolong.jpg",
          reading: 102,
          detail:
          ...
          collection: 92,
          dateTime: "24小时前",
          headImgSrc: "../../../static/images/dynamic/xiaolong.jpg",
          author: "猫是猫的猫",
          date: "Nov 20 2016",
          avatar: "../../../static/images/dynamic/5.png",
          postId: 3
        },
        {
          ...
          imgSrc: "../../../static/images/dynamic/vr.png",
          reading: 102,
          detail:
          ...
          collection: 26,
          dateTime: "24小时前",
          headImgSrc: "../../../static/images/dynamic/vr.png",
          author: "深白色",
          date: "Nov 20 2016",
          avatar: "../../../../../static/images/dynamic/3.png",
          postId: 4
        },
        {
          ...
          imgSrc: "../../../static/images/dynamic/iqiyi.png",
          reading: 96,
          detail:
          ...
          collection: 26,
          dateTime: "21小时前",
          headImgSrc: "../../../static/images/dynamic/iqiyi.png",
          author: "深白色",
          date: "Nov 20 2016",
          avatar: "../../..../../../static/images/dynamic/5.png",
          postId: 5
